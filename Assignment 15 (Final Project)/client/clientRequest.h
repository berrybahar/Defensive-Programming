...
#define REGISTRATION 825
#define RECCONECTION 827
#define PROPER_CRC 900
#define NONPROPER_CRC 901
#define FOURTH_NONPROPER_CRC 902

#define SEND_PUBLIC_KEY 826
#define SEND_FILE 828
...
class ClientRequest
{
	...
	public:
		ClientRequest() {}
		ClientRequest(const std::string& clientID, int version, int code, const std::string& userName,
